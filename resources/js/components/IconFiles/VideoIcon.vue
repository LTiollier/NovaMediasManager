<template>
    <svg version="1.1" id="video_svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
         x="0px" y="0px"
        ...
        <text transform="matrix(1 0 0 1 35 237.3994)" class="st5 st3 st6">VIDEO</text>
    </svg>
</template>
